...
/*The following function reads the command type, and initializes the p_set pointer to point to the appropriate function.
...
the 'validInput' flag will be lit, and this will cause the getCommand program to skip to the next command
 */
void readCommandType(void** pointer, Vars* vars)
{
    void* p;
