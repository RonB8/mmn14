 ...
 *For the sake of order, all functions called by the user receive 3 parameters, and thus the 'p_set' pointer corresponds to any function of the above type. When a function receives a parameter that it does not use, the parameter will read 'nothing'.
